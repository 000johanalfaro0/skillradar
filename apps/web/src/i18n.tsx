...
const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'detail.level': 'Level',
    'detail.queued': 'Automated analysis is queued — check back after the next scheduled run.',
  ...
  es: {
    ...
    'search.placeholder': 'Busca por significado… p. ej., “crear gráficos atractivos”',
    ...
    'state.noMatches': 'Sin resultados. Prueba otra búsqueda o etiqueta.',
    ...
    'detail.level': 'Nivel',
    'detail.queued': 'El análisis automatizado está en cola. Vuelve después de la próxima ejecución programada.',
